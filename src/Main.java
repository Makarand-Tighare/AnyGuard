...
//All Panels---------------------------------------------------------------------------------------------------------------------
                        ...
                        JLabel author1 = new JLabel("<html><u>Makarand Tighare</html>");
                        home.add(author1);
                        Font adminfont = new Font("serif", Font.PLAIN, 16);
                        author1.setForeground(new Color(0, 127, 255));
                        author1.setFont(adminfont);
                        author1.setBounds(300,130,180,100);
                        author1.addMouseListener(new MouseAdapter() {
                            @Override
                            public void mouseClicked(MouseEvent e) {
                                try {
                                    Desktop.getDesktop().browse(new URI("https://www.linkedin.com/in/Makarand-Tighare/"));
                                } catch (Exception ex) {
                                    ex.printStackTrace();
                                }
                            }
